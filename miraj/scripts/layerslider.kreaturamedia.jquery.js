...
*/
	...
	layerSlider.options = {
		...
		touchNav			: false,						// Touch-control (on mobile devices)
		...
		skinsPath: '/css/',                           // You can change the default path of the skins folder. Note, that you must use the slash at the end of the path.
